...
> *"Order a hot and spicy paneer burger from Tripti for 1:00 PM"*
...
```bash
git clone https://github.com/aayush-infinity2/food-booking-whatsapp-bot.git
...
MYSQL_HOST=lpu-food-db-food-booking-whatsapp-bot.i.aivencloud.com
MYSQL_PORT=25642
MYSQL_USER=avnadmin
